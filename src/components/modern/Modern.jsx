...
import Block from "../../assets/modern/Product.svg";

const Modern = () => {
  return (
    <div className='modern container section'>
      <div className="modern__block">
        <div className="modern__left">
        <img src={Box} alt="" className="modern__img1" />
        <div className="modern__case"></div>
      <img src={Block} alt="" className="modern__img2" />
      </div>
      <div className="modern__right">
        <h2 className="modern__title">WE PROVIDE MODERN
SHOES</h2>
<p className="modern__text">Design for the way you live your life. Atoms are beautiful in their
